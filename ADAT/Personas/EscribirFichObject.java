...
public class EscribirFichObject {
  public static void main(String[] args) throws IOException {   
   ...
   File fichero = new File("/Users/Pedro/Documents/personas.dat");//declara el fichero
   FileOutputStream fileout = new FileOutputStream(fichero,true);  //crea el flujo de salida
    //conecta el flujo de bytes al flujo de datos
   ObjectOutputStream dataOS = new ObjectOutputStream(fileout);  
   
   String nombres[] = {"Ana","Luis Miguel","Alicia","Pedro","Manuel","AndrÈs",
                       "Julio","Antonio","MarÌa Jes˙s"};
