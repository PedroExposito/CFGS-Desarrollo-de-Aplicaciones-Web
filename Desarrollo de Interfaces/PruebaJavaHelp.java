 ...
 * 
 * Una aplicaciÛn tonta con dos ventanas y un men˙. En ella se puede ver la 
...
public class PruebaJavaHelp {
	...
	private void ponLaAyuda() {
		try {
			...
			hb.enableHelpOnButton(itemAyuda, "ventana1", helpset);
			hb.enableHelpKey(principal.getContentPane(), "ventana1",
					helpset);
			hb.enableHelpKey(secundaria.getContentPane(), "ventana2",
					helpset);
	...
	/**
	 * øTal vez crea la ventana secundaria?
	 */
